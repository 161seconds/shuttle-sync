...
router.use('/friends', require('./friendship.routes').default);
router.use('/payment', require('./payment.routes').default);
router.use('/vouchers', require('./voucher.routes').default);
