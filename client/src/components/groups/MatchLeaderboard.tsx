...
import { Trophy, Swords, Send, Info, Zap } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className={`p-5 rounded-2xl ${t.bg.elevated} border ${t.border.subtle} relative overflow-hidden`}>
                ...
                <form onSubmit={handleQuickSubmit}>
                    ...
                    <button
                        type="submit"
                        className="w-full bg-emerald-500 hover:bg-emerald-400 text-black font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
                    >
