        ...
        <>
            ...
            <AnimatePresence>
                {isSideBarOpen && (
                    <motion.div
                        ...
                        className={`fixed inset-0 z-40 bg-black/40 backdrop-blur-sm ${page !== 'map' ? 'md:hidden' : ''}`}
                    />
                )}
            </AnimatePresence>
            ...
            >
                ...
                <button
                    ...
                    className={`p-5 flex items-center gap-3 hover:bg-muted transition-colors group border-b ${t.border.subtle} text-left`}
                >
