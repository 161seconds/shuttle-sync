...
import { ChevronLeft, ChevronRight, Loader2, Lock, User, X, Clock, Info } from 'lucide-react';
            ...
            <div className="bg-[#0a0f16]/60 backdrop-blur-3xl rounded-2xl border border-white/5 flex flex-col flex-1 min-h-0 overflow-hidden relative shadow-[0_8px_30px_rgb(0,0,0,0.4)]">
                ...
                <div className="flex-1 overflow-auto bg-transparent scroll-smooth">
                    <div className="min-w-[1440px] flex flex-col min-h-full">
                        ...
                        {/* Fixed Header Row */}
                        <div className="flex border-b border-white/5 bg-white/5 sticky top-0 z-30 shrink-0 shadow-sm backdrop-blur-xl">
                            <div className="w-48 shrink-0 p-4 border-r border-white/5 font-medium text-emerald-400 flex items-center justify-center bg-black/40 sticky left-0 z-40 shadow-[2px_0_8px_-4px_rgba(0,0,0,0.5)]">
                                Danh sách Sân
                            </div>
                            <div className="flex-1 flex">
                                {hours.map(hour => (
                                    <div key={`header-${hour}`} className="flex-1 border-r border-white/5 p-2 text-center text-sm font-medium text-gray-400">
                                ...
                                courts.map(court => {
                                    ...
                                    return (
                                        <div key={court._id} className="flex border-b border-white/5 min-h-[80px] hover:bg-white/5 transition-colors group">
                                            {/* Row Label */}
                                            <div className="w-48 shrink-0 p-4 border-r border-white/5 bg-black/40 backdrop-blur-md flex flex-col justify-center sticky left-0 z-20 shadow-[2px_0_8px_-4px_rgba(0,0,0,0.5)]">
                                            ...
                                            <div className="flex-1 relative cursor-crosshair">
                                                ...
                                                <div className="absolute inset-0 flex">
                                                    {hours.map(hour => (
                                                        <div
                                                            key={`grid-${hour}`}
                                                            className="flex-1 border-r border-white/5 hover:bg-white/10 transition-colors cursor-crosshair"
                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            className={`absolute top-1.5 bottom-1.5 rounded-md px-2.5 py-1 text-xs overflow-hidden border shadow-sm z-10 transition-all hover:scale-[1.01] hover:z-20 cursor-pointer flex flex-col justify-center
                                                                ${isOffline
                                                                    ? 'bg-gradient-to-r from-white/10 to-white/5 border-white/10 text-gray-300 backdrop-blur-md shadow-inner'
                                                                    : 'bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border-emerald-500/40 text-emerald-100 hover:border-emerald-400/70 hover:from-emerald-500/30 hover:to-teal-500/30 hover:shadow-[0_0_15px_rgba(16,185,129,0.3)] backdrop-blur-md'
                                                                }
                                                            `}
