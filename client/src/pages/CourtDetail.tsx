...
import {
    ...
    Share2, Shield, Calendar, ChevronRight, Loader2
} from 'lucide-react';
            ...
            <div className="relative h-56 sm:h-72 overflow-hidden">
                ...
                <div className="absolute top-0 left-0 right-0 p-4 flex items-center justify-between">
                    <button onClick={onBack}
                        className="w-10 h-10 rounded-xl bg-card backdrop-blur-sm flex items-center justify-center text-foreground hover:bg-card transition-colors">
                        <ChevronLeft className="w-5 h-5" />
                    </button>
                    <div className="flex gap-2">
                        <button onClick={handleLike}
                            className="w-10 h-10 rounded-xl bg-card backdrop-blur-sm flex items-center justify-center hover:bg-card transition-colors">
                            {loadingLike ? (
                        ...
                        <button className="w-10 h-10 rounded-xl bg-card backdrop-blur-sm flex items-center justify-center text-foreground hover:bg-card transition-colors">
            ...
            <div className="max-w-3xl mx-auto px-4 -mt-6 relative z-10 space-y-4">
                ...
                <div className={`${DS.bg.card} rounded-2xl border ${DS.border.subtle} p-5`}>
                    ...
                    <div className="flex items-center gap-4 flex-wrap mb-3">
                        ...
                        <span className={`text-sm ${DS.text.muted}`}>{court.courts?.length || 0} sân con</span>
