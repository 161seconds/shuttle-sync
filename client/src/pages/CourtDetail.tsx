            ...
            <div className="relative h-56 sm:h-72 overflow-hidden">
                ...
                <div className="absolute top-0 left-0 right-0 p-4 flex items-center justify-between">
                    <button onClick={onBack}
                        className="w-10 h-10 rounded-xl bg-black/40 backdrop-blur-sm flex items-center justify-center text-foreground hover:bg-black/60 transition-colors">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="w-10 h-10 rounded-xl bg-black/40 backdrop-blur-sm flex items-center justify-center text-foreground hover:bg-black/60 transition-colors">
