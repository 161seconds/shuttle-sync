...
export default function MyTournaments({ onBack }: Props) {
    ...
    if (loading && !tournament) {
        return (
            <div className={`min-h-screen w-full${t.bg.base} pb-24 flex flex-col items-center justify-center relative overflow-hidden bg-background`}>
                ...
                <p className="mt-8 text-sm font-black text-muted-foreground tracking-[0.3em] uppercase">Đang tải giải đấu...</p>
            </div>
        );
    }
                                    ...
                                    {matchesInRound.map((match, index) => {
                                        ...
                                        return (
                                            <div key={match._id} className="relative flex-1 flex flex-col justify-center py-2 group/match">
                                                ...
                                                {/* Left Connector */}
                                                {!isFirstRound && (
                                                    <div className="absolute -left-8 top-1/2 w-8 border-t-[3px] border-border -translate-y-1/2 transition-colors duration-500 group-hover/match:border-border" />
                                                )}
                                                ...
                                                >
                                                    ...
                                                    <div className="py-2.5 relative z-20">
                                                        ...
                                                        <div className="flex items-center justify-center -my-3.5 relative z-30 pointer-events-none">
                                                            <div className="bg-background border border-border shadow-lg rounded-full px-2.5 py-1 text-[9px] font-black text-muted-foreground tracking-widest">VS</div>
                                                        </div>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="relative p-7 space-y-10 z-10">
                        ...
                        <div className="flex-1 flex flex-col items-center gap-4">
                            ...
                            <div className="relative group w-full">
                                ...
                                <input 
                                    ...
                                    className="relative w-full h-28 text-center text-5xl font-black bg-card border border-border rounded-[1.5rem] text-foreground outline-none focus:border-emerald-500 transition-all shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)] placeholder:text-muted-foreground"
                                    placeholder="0"
                                />
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-[11px] font-black text-muted-foreground uppercase tracking-widest">Chọn đội chiến thắng</p>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <span className={`text-sm font-black relative z-10 transition-colors line-clamp-1 w-full text-center ${winnerId === match.team1Id ? 'text-emerald-400' : 'text-muted-foreground'}`}>{team1Name}</span>
                            </button>
                            <button 
                            ...
                            >
                                ...
                                <span className={`text-sm font-black relative z-10 transition-colors line-clamp-1 w-full text-center ${winnerId === match.team2Id ? 'text-emerald-400' : 'text-muted-foreground'}`}>{team2Name}</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                {/* Footer Buttons */}
                <div className="p-7 bg-background flex gap-4 border-t border-border relative z-10">
                    <button onClick={onClose} className="flex-1 py-4 rounded-2xl font-black text-muted-foreground hover:text-foreground hover:bg-muted transition-all border border-transparent hover:border-border">
                        HỦY BỎ
                    </button>
                    <button 
                        onClick={() => onSave({ 
